  ...
  <div class="app-container">
    <div class="table-title flex-bet">
      <div class="flex-start">
        <span >商品列表</span>
        <el-button class="add-btn" size="mini" type="primary" @click="$router.push('/GoodsList/detail')">添加商品</el-button>
      </div>
      <el-input size="small" v-model="reqParams.keyword" placeholder="请输入商品名称" @keyup.enter.native="fetchData"></el-input>
    </div>
    <el-table
...
<script>
import { getList,deleteApi } from '@/api/goods'
